...
describe('hsql in memory', function() {
    ...
    describe('query', function() {
        ...
        it('should use column alias when selecting', function() {
            jt400.query<any>('select ID, NAME MYNAME from testtbl')
                .then(function(res) {
    ...
    describe('insert', function() {
        it('should insert and return id', function() {
            return jt400.insertAndGetId('insert into testtbl (NAME) values(?)', ['foo'])
                .then(function(res) {
        ...
        it('should insert date and timestamp', function() {
            return jt400.insertList('testtbl', 'ID', [{
