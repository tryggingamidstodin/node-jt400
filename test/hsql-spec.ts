...
describe('hsql in memory', () => {
    ...
    beforeEach(() => {
        return jt400.update('create table testtbl (ID DECIMAL(15, 0) GENERATED BY DEFAULT AS IDENTITY(START WITH 1234567891234), NAME VARCHAR(300), START DATE, STAMP TIMESTAMP, PRIMARY KEY(ID))')
    ...
    describe('insert', () => {
        it('should insert and return id', async () => {
            const res = await jt400.insertAndGetId('insert into testtbl (NAME) values(?)', ['foo']);                
    ...
    describe('batch update', () => {
        ...
        it('should insert batch', async () => {
            const res = await jt400.batchUpdate('insert into testtbl (NAME,START) values(?, ?)', [
                ['foo', '2015-01-02'],
                ['bar', '2015-03-04']
            ]);                       
    ...
    describe('execute', () => {
        ...
        it('should get update count', async () => {
            const statement = await jt400.execute('update testtbl set NAME=?', ['testing']);                
        ...
        it('should close stream', done => {
            ...
            Promise.all(data.map(item => jt400.update('insert into testtbl (NAME) values(?)', ['n' + item]))).then(() => {
                const res: any[] = [];
    ...
    describe('transaction', () => {
        ...
        it('should commit', () => {
            ...
            return jt400.transaction(transaction => {
                return transaction.insertAndGetId("insert into testtbl (NAME) values('Transaction 1')").then(res => {
                    rowId = res;
